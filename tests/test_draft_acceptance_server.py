...
def test_xiaohongshu_local_profile_draft_is_not_an_acceptance_platform() -> None:
    with pytest.raises(ValueError, match="xiaohongshu"):
        acceptance.build_acceptance_app(("xiaohongshu",), "DRAFT_ONLY")


def test_xiaohongshu_local_resume_is_not_an_acceptance_escape_hatch() -> None:
    with pytest.raises(ValueError, match="xiaohongshu"):
