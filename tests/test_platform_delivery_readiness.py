...
def test_xiaohongshu_local_profile_draft_is_not_delivery_ready() -> None:
    assert "xiaohongshu" not in readiness_by_platform()
    assert not can_run_stable_image_draft("xiaohongshu")
